...
namespace Flame {
	...
	EditorLayer3D::EditorLayer3D()
		:Layer("EditorLayer3D"), m_CameraController(1280.f / 720.f, true)
	{
	}
	...
	void EditorLayer3D::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<KeyPressedEvent>(FLAME_BIND_EVENT_FN(EditorLayer3D::OnKeyPressed));
		dispatcher.Dispatch<MouseButtonPressedEvent>(FLAME_BIND_EVENT_FN(EditorLayer3D::OnMouseButtonPressed));
	}
	...
	bool EditorLayer3D::OnMouseButtonPressed(MouseButtonPressedEvent& e)
	{
